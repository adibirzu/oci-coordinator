...
tracer = trace.get_tracer("oci-log-analytics-agent")
...
class LogAnalyticsAgent(BaseAgent, SelfHealingMixin):
    ...
    async def _parse_query_node(self, state: LogAnalyticsState) -> dict[str, Any]:
        ...
        with tracer.start_as_current_span("log_analytics.parse_query") as span:
    ...
    async def _search_logs_node(self, state: LogAnalyticsState) -> dict[str, Any]:
        ...
        with tracer.start_as_current_span("log_analytics.search_logs") as span:
            span.set_attribute("time_range", state.time_range)
            ...
            span.set_attribute("log_entries_count", len(log_entries))
    ...
    async def _detect_patterns_node(self, state: LogAnalyticsState) -> dict[str, Any]:
        ...
        with tracer.start_as_current_span("log_analytics.detect_patterns") as span:
            span.set_attribute("entry_count", len(state.log_entries))
    ...
    async def _correlate_node(self, state: LogAnalyticsState) -> dict[str, Any]:
        ...
        with tracer.start_as_current_span("log_analytics.correlate") as span:
    ...
    async def _output_node(self, state: LogAnalyticsState) -> dict[str, Any]:
        ...
        with tracer.start_as_current_span("log_analytics.output"):
    ...
    async def invoke(self, query: str, context: dict[str, Any] | None = None) -> str:
        ...
        with tracer.start_as_current_span("log_analytics.invoke") as span:
